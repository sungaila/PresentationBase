...
namespace PresentationBase.DtoConverters
{
	...
	/// This enables conversion with <see cref="DtoConverterExtensions.ToModel{TModel}(ViewModel)" and <see cref="DtoConverterExtensions.ToViewModel{TViewModel}(object)"/>./>
	/// </summary>
